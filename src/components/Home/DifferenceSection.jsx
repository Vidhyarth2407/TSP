...
const DifferenceSection = () => {
    return (
        <React.Fragment>
            <section className="bg-[var(--color-yellow-gold)] text-white py-12 md:py-32 px-8 md:px-12 rounded-[20px] md:rounded-[30px] mx-4 md:mx-auto max-w-[1200px] my-8 md:my-16 relative shadow-2xl">
