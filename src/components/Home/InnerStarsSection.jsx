    ...
    return (
        <section className="py-20 lg:py-24 px-4 max-w-[1200px] mx-auto relative text-center">
            <div className="max-w-5xl mx-auto mb-16" data-aos="fade-up">
                <h2 className="text-2xl md:text-4xl text-[var(--color-dark-navy)] mb-6 uppercase leading-tight font-[var(--font-heading)] font-bold text-center">
                    WHY DOES YOUR CHILD NEED INNER STARS?
                </h2>
                <p className="text-lg font-[var(--font-accent)] leading-relaxed mx-auto text-justify md:text-center" style={{ color: '#636466', wordSpacing: '-0.02em', hyphens: 'auto', wordBreak: 'break-word', textJustify: 'inter-word' }}>
